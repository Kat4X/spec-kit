...
Если текущий `verification.md` создан `spec-kit tasks`, сохрани его верхнеуровневую структуру и заполни фактическими результатами. Если структура старая или неполная — аккуратно дополни её нужными секциями, не теряя существующие записи.
