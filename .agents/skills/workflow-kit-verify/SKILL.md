...
description: "Используй когда пользователь просит финально проверить Workflow Kit change после реализации или перед закрытием: сверить spec.md/plan.md/scope.md/tasks.json/verification.md, запустить проверки, найти расхождения и зафиксировать результат."
---
