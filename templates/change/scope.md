...
Если файл не указан явно ни в одной секции — агент считает его `Requires confirmation`, кроме очевидного чтения и локальных тестовых файлов, напрямую указанных в `tasks.md`.
